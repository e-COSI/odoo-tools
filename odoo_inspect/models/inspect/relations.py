...
class Relations(object):
    ...
    def __init__(self, odoo, models, maxdepth=1, whitelist=None, blacklist=None,
        ...
        for model in models:
            self._build_relations(self.odoo.env[model], 0)
    ...
    def _create_node(self, name, type_, tpl=None):
        ...
        types = {
            'relation': {
                ...
                'label': (tpl or name).decode('utf-8'),
            },
            'm2m_table': {
                'margin': '0',
                'shape': tpl and 'none' or 'record',
